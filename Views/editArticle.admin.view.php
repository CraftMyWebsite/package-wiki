...
<form action="" method="post" class="card">
    ...
    <div class="grid-2">
        ...
        <div>
            <div class="icon-picker" data-id="icon" data-name="icon"
                 ...
                 data-placeholder="Sélectionner un icon" data-value="<?= $article->getIcon() ?>"></div>
        </div>
    </div>
    <div class="grid-2">
        <div>
            <label for="category"><?= LangManager::translate('wiki.add.article_categorie') ?> :</label>
        ...
        <div>
            <label class="toggle">
                ...
                <input type="checkbox" id="isDefine" name="isDefine"
                       class="toggle-input" <?= ($article->getIsDefine() ? 'checked' : '') ?>>
    ...
    <textarea id="content" class="tinymce" name="content"
              data-tiny-height="500"><?= $article->getContentNotTranslate() ?></textarea>
    <div class="mt-4">
